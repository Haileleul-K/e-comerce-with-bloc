...
//
//     final latestProductsResponse = latestProductsResponseFromJson(jsonString);

import 'dart:convert';

LatestProductsResponse latestProductsResponseFromJson(String str) => LatestProductsResponse.fromJson(json.decode(str));

String latestProductsResponseToJson(LatestProductsResponse data) => json.encode(data.toJson());
...
class LatestProductsResponse {
    ...
    factory LatestProductsResponse.fromJson(Map<String, dynamic> json) => LatestProductsResponse(
        ok: json["ok"],
